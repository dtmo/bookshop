...
The Anonymous actor represents a user who is viewing the site without having
...
The Admin user is able to modify the set of and details of books available. They
